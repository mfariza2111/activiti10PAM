package com.example.activiti10pam.adapter;
...
import com.example.activiti10pam.R;
import com.example.activiti10pam.database.barang;
...
public class AdapterBarang extends
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View v) {
            super(v);
            tvTitle = (TextView) v.findViewById(R.id.tv_barang);
        }
    }
    @Override
